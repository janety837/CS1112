...
class Item:
    ...
    def draw(self, t):
        ...
        """
        if t<self.picked_window.right or self.picked_window==None:
            draw_rect(self.loc[0]-0.5,self.loc[1]-0.5,1,1,'r')
            s=str(self.id_)
            plt.text(self.loc[0],self.loc[1],s,horizontalalignment="center")
